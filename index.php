<?php
/**
 * index.php a list page based on demo_shared.php
 *
...
# SQL statement - PREFIX to distinguish your app
$sql = "select * from 16q1_surveys ";

//END CONFIG AREA --------------------------------------------

get_header(); #defaults to header_inc.php
?>
<h3 align="center">SURVEYS - <?php echo $config->titleTag; ?></h3>
<?php
...
{#there are records - present data
	...
	{# pull data from associative array
		 echo '<p>';
		 echo 'Title: <b><a href="survey_view.php?id=' . $row['SurveyID'] . '">' . $row['Title'] . '</a></b><br />';
